...
var $author$project$Common$Select = function (a) {
	return {$: 'Select', a: a};
};
...
var $author$project$BarChart$h = 600;
...
var $author$project$BarChart$padding = 30;
...
var $author$project$BarChart$yScale = A2(
	$gampleman$elm_visualization$Scale$linear,
	_Utils_Tuple2($author$project$BarChart$h - (2 * $author$project$BarChart$padding), 0),
	_Utils_Tuple2(0, 140));
var $author$project$BarChart$column = F2(
	function (scale, _v0) {
		var key = _v0.a;
		var value = _v0.b;
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Common$Select(key))
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							...
							A2($gampleman$elm_visualization$Scale$convert, scale, key)),
							$elm_community$typed_svg$TypedSvg$Attributes$InPx$y(
							A2($gampleman$elm_visualization$Scale$convert, $author$project$BarChart$yScale, value)),
							...
							($author$project$BarChart$h - A2($gampleman$elm_visualization$Scale$convert, $author$project$BarChart$yScale, value)) - (2 * $author$project$BarChart$padding))
						]),
					_List_Nil),
					A2(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								A2($gampleman$elm_visualization$Scale$toRenderable, $elm$core$String$fromInt, scale),
								key)),
							$elm_community$typed_svg$TypedSvg$Attributes$InPx$y(
							A2($gampleman$elm_visualization$Scale$convert, $author$project$BarChart$yScale, value) - 5),
...
var $author$project$BarChart$w = 800;
...
var $author$project$BarChart$xScale = function (model) {
	return A3(
		...
		_Utils_Tuple2(0, $author$project$BarChart$w - (2 * $author$project$BarChart$padding)),
		A2($elm$core$List$map, $elm$core$Tuple$first, model));
};
var $author$project$BarChart$xAxis = function (model) {
	return A2(
		...
		A2(
			...
			$author$project$BarChart$xScale(model)));
};
...
var $author$project$BarChart$yAxis = A2(
	$gampleman$elm_visualization$Axis$left,
	_List_fromArray(
		[
			$gampleman$elm_visualization$Axis$tickCount(5)
		]),
	$author$project$BarChart$yScale);
var $author$project$BarChart$chart = function (model) {
	return A2(
		$elm_community$typed_svg$TypedSvg$svg,
		_List_fromArray(
			[
				A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, $author$project$BarChart$w, $author$project$BarChart$h)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm_community$typed_svg$TypedSvg$Types$Translate, $author$project$BarChart$padding - 1, $author$project$BarChart$h - $author$project$BarChart$padding)
							]))
					]),
				_List_fromArray(
					[
						$author$project$BarChart$xAxis(model)
					])),
				A2(
				$elm_community$typed_svg$TypedSvg$g,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm_community$typed_svg$TypedSvg$Types$Translate, $author$project$BarChart$padding - 1, $author$project$BarChart$padding)
							]))
					]),
				_List_fromArray(
					[$author$project$BarChart$yAxis])),
				A2(
				$elm_community$typed_svg$TypedSvg$g,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm_community$typed_svg$TypedSvg$Types$Translate, $author$project$BarChart$padding, $author$project$BarChart$padding)
							])),
						$elm_community$typed_svg$TypedSvg$Attributes$class(
						_List_fromArray(
							['series']))
				...
				A2(
					$elm$core$List$map,
					$author$project$BarChart$column(
						$author$project$BarChart$xScale(model)),
					model))
			]));
};
...
var $author$project$Main$getMovesForPoints = F2(
	function (dict, points) {
		return A2(
			$elm$core$List$map,
			...
			A2(
				...
				_List_Nil,
				A2($elm$core$Dict$get, points, dict)));
	});
...
var $author$project$Main$Card = F2(
	function (name, _function) {
		return {_function: _function, name: name};
	});
var $author$project$Main$anke = A2(
	$author$project$Main$Card,
	'A',
	function (assets) {
		return (assets.ataola >= 3) ? $elm$core$Maybe$Just(
			_Utils_update(
				assets,
				{ataola: assets.ataola - 3, quombao: 2 * assets.quombao})) : $elm$core$Maybe$Nothing;
	});
var $author$project$Main$elfant = A2(
	$author$project$Main$Card,
	'E',
	function (assets) {
		return (assets.quombao >= 2) ? $elm$core$Maybe$Just(
			_Utils_update(
				assets,
				{quombao: assets.quombao - 2, tamoro: assets.tamoro + 5})) : $elm$core$Maybe$Nothing;
	});
var $author$project$Main$joey = A2(
	$author$project$Main$Card,
	'J',
	function (assets) {
		return (assets.quombao >= 1) ? $elm$core$Maybe$Just(
			_Utils_update(
				assets,
				{quombao: assets.quombao - 1, tamoro: assets.tamoro + assets.ataola})) : $elm$core$Maybe$Nothing;
	});
var $author$project$Main$pfitschiPfeil = A2(
	$author$project$Main$Card,
	'P',
	function (assets) {
		return (assets.tamoro >= 3) ? $elm$core$Maybe$Just(
			_Utils_update(
				assets,
				{ataola: assets.ataola + 1, quombao: assets.quombao + 2, tamoro: assets.tamoro - 3})) : $elm$core$Maybe$Nothing;
	});
var $author$project$Main$sunJ = A2(
	$author$project$Main$Card,
	'S',
	function (assets) {
		return (assets.tamoro >= 2) ? $elm$core$Maybe$Just(
			_Utils_update(
				assets,
				{ataola: assets.quombao, quombao: assets.ataola, tamoro: assets.tamoro - 2})) : $elm$core$Maybe$Nothing;
	});
var $author$project$Main$teledahner = A2(
	$author$project$Main$Card,
	'T',
	function (assets) {
		return (assets.ataola >= 4) ? $elm$core$Maybe$Just(
			_Utils_update(
				assets,
				{ataola: (assets.ataola - 4) + assets.tamoro, tamoro: 0})) : $elm$core$Maybe$Nothing;
	});
var $author$project$Main$allCards = _List_fromArray(
	[$author$project$Main$anke, $author$project$Main$elfant, $author$project$Main$joey, $author$project$Main$pfitschiPfeil, $author$project$Main$sunJ, $author$project$Main$teledahner]);
var $author$project$Main$allPermutations_ = F2(
	function (hs, ts) {
		if (!ts.b) {
			return _List_fromArray(
				[_List_Nil]);
			...
			var x = ts.a;
			var xs = ts.b;
			var rests = _Utils_ap(hs, xs);
			return _Utils_ap(
				A2(
					$elm$core$List$map,
					$elm$core$List$cons(x),
					A2($author$project$Main$allPermutations_, _List_Nil, rests)),
				A2(
					$author$project$Main$allPermutations_,
					A2($elm$core$List$cons, x, hs),
					xs));
		}
	});
var $author$project$Main$allPermutations = $author$project$Main$allPermutations_(_List_Nil);
var $author$project$Main$kleisli = F2(
	function (f, g) {
		return A2(
			$elm$core$Basics$composeR,
			f,
			$elm$core$Maybe$andThen(g));
	});
var $author$project$Main$playCards = function (cards) {
	return A3(
		$elm$core$List$foldr,
		$author$project$Main$kleisli,
		$elm$core$Maybe$Just,
		A2(
			$elm$core$List$map,
			function ($) {
...
var $author$project$Main$Assets = F3(
	function (ataola, quombao, tamoro) {
		return {ataola: ataola, quombao: quombao, tamoro: tamoro};
	});
var $author$project$Main$startAssets = A3($author$project$Main$Assets, 4, 4, 5);
var $author$project$Main$results = A2(
	$elm$core$List$map,
	function (cards) {
		return _Utils_Tuple2(
			$elm$core$String$concat(
				A2(
					...
					cards)),
			A2($author$project$Main$playCards, cards, $author$project$Main$startAssets));
	},
	$author$project$Main$allPermutations($author$project$Main$allCards));
var $author$project$Main$resultDict = A2(
...
var $author$project$Main$numIllegalMoves = $elm$core$List$length(
	A2($author$project$Main$getMovesForPoints, $author$project$Main$resultDict, -1));
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Main$invalidScoresLink = function (model) {
	return A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
				$elm$html$Html$Events$onClick(
				$author$project$Common$Select(-1)),
				...
				$elm$core$String$concat(
					_List_fromArray(
						[
							...
							$elm$core$String$fromInt($author$project$Main$numIllegalMoves),
							' Ungültige Züge'
						])))
			]));
};
var $elm$html$Html$li = _VirtualDom_node('li');
var $author$project$Main$movesText = function (numMoves) {
	return (numMoves > 1) ? $elm$core$String$concat(
		_List_fromArray(
			[
				$elm$core$String$fromInt(numMoves),
				' Spielzüge '
			])) : $elm$core$String$concat(
		_List_fromArray(
			[
...
var $author$project$Main$validScoresTupleList = $elm$core$Dict$toList(
	A2(
		$elm$core$Dict$map,
		$elm$core$Basics$always(
			A2($elm$core$Basics$composeL, $elm$core$Basics$toFloat, $elm$core$List$length)),
		A2(
			$elm$core$Dict$filter,
			F2(
				function (k, v) {
					return !_Utils_eq(k, -1);
				}),
			$author$project$Main$resultDict)));
var $author$project$Main$numValidMoves = A3(
	$elm$core$List$foldl,
	A2($elm$core$Basics$composeL, $elm$core$Basics$add, $elm$core$Tuple$second),
	0,
	$author$project$Main$validScoresTupleList);
var $author$project$Main$pointsText = F2(
	function (numMoves, points) {
		return (numMoves > 1) ? ((points < 0) ? 'sind illegal:' : $elm$core$String$concat(
			_List_fromArray(
				[
					'haben ',
					$elm$core$String$fromInt(points),
					' Punkte:'
				]))) : ((points < 0) ? 'ist illegal:' : $elm$core$String$concat(
			_List_fromArray(
				[
					'hat ',
					$elm$core$String$fromInt(points),
...
var $author$project$Main$view = function (model) {
	var movesList = A2($author$project$Main$getMovesForPoints, $author$project$Main$resultDict, model.selected);
	var movesUl = A2(
		$elm$html$Html$ul,
		_List_Nil,
		A2(
			...
			movesList));
	var numMoves = $elm$core$List$length(movesList);
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$BarChart$chart($author$project$Main$validScoresTupleList)
					])),
				...
				$elm$core$String$concat(
					_List_fromArray(
						[
							'Im Balkendiagramm: ',
							$elm$core$String$fromFloat($author$project$Main$numValidMoves),
							' gültige Züge'
						]))),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$author$project$Main$invalidScoresLink(model),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$elm$html$Html$text('Auf Balken klicken, um Spielzüge angezeigt zu bekommen.'),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				$elm$html$Html$text(
				$elm$core$String$concat(
					_List_fromArray(
						[
							$author$project$Main$movesText(numMoves),
							A2($author$project$Main$pointsText, numMoves, model.selected)
						]))),
				A2($elm$html$Html$br, _List_Nil, _List_Nil),
				movesUl
			]));
